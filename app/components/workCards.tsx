  ...
  return (
    ...
    >
      ...
      <Link
        ...
        aria-label={`View details for ${work.client}`}
      />
      ...
      >
        ...
        <div className="overflow-hidden mb-1 flex justify-between items-center relative z-10">
          ...
          <a
            ...
            className="text-SoftApricot text-xs font-bold tracking-[0.25em] uppercase transform translate-y-full group-hover:translate-y-0 transition-transform duration-800 delay-100 ease-[cubic-bezier(0.16,1,0.3,1)] bg-white/10 px-2 py-1 rounded-full pointer-events-auto"
          >
            LIVE
          </a>
        </div>
