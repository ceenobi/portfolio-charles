...
export default function Logo() {
  ...
  return (
    ...
    >
      <div className="w-12 h-12 bg-BlackBerryCream rounded-full flex items-center justify-center shadow-lg border border-white/10 shrink-0">
        <h1 className="font-bold text-xl text-white">CM</h1>
      </div>
      <div
