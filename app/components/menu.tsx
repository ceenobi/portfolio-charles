...
export default function Menu({ links }: MenuProps) {
  ...
  return (
    <>
      {/* ── Fixed Pill Toggle Button ── */}
      <button
        onClick={() => setIsOpen(!isOpen)}
        className="z-100 flex items-center bg-BlackBerryCream text-white rounded-full transition-all duration-300 hover:scale-105 active:scale-95 shadow-2xl border border-white/5 h-12 pr-4 overflow-hidden cursor-pointer"
      >
        ...
        {isOpen && (
          ...
          >
            ...
            >
              ...
              {/* Decorative text side or "Studio" active state indicator */}
              <div className="hidden lg:flex flex-col justify-end items-end text-BlackBerryCream/40 max-w-[300px] text-right">
                <p className="text-sm font-medium leading-relaxed uppercase tracking-[0.3em] mb-4 text-BlackBerryCream/60">
                  Creative Design & Software Engineering
                </p>
                <div className="w-[100px] h-px bg-BlackBerryCream/20 mb-8" />
                <p className="text-xs tracking-wider">
                  Pushing boundaries of digital experiences through creativity,
